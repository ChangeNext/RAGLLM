...
if __name__ == "__main__":
    ...
    metric = retrieval(protocol="all", dataset=test_dataset, threshold=0.95, model=temollm.model, device="cuda", save_dir = save_dir, train_mode = False, batch_size=256, logger=None, bf16 = temollm.model.bf16, nsim_dataset=nsim_dataset)